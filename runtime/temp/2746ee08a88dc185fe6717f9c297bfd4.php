<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\WAMP64\www\tpshop\public/../application/home\view\order\send.html";i:1532181668;s:54:"E:\WAMP64\www\tpshop\application\home\view\layout.html";i:1531221661;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
                        ...
                        <div class="order-detail">
                            ...
                            <div class="choose-title">
                                <label data-toggle="checkbox" class="checkbox-pretty ">
                                       <input type="checkbox" checked="checked"><span><?php echo $v['create_time']; ?>　订单编号:<?php echo $v['order_sn']; ?>  店铺：哇哈哈 <a>和我联系</a></span>
                                 </label>
                                    ...
                                    <tr>
                                        <td width="35%">
                                            <div class="typographic"><img src="/static/home/img/goods.png" />
                                                <a href="#" class="block-text"><?php echo $v['goods_name']; ?></a>
                                                <?php foreach($v['attr_values'] as $val): ?>
                                                <span class="guige">规格：<?php echo $val['attr_value']; ?></span>
                                                <?php endforeach; ?>
                                            </div>
                                        </td>
    ...
    <script>
        //定义页面加载事件
        $(function(){
            //获取订单列表中 支付状态 paystatus的值
            var score = $("li").attr("paystatus").val();
            console.log(score);
        });
    </script>
