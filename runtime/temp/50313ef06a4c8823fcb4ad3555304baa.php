<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"E:\WAMP64\www\tpshop\public/../application/home\view\order\test.html";i:1532502111;s:54:"E:\WAMP64\www\tpshop\application\home\view\layout.html";i:1531221661;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="yui3-g home">
                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="list-items">
                         <dl>
							<dt><i>·</i> 订单中心</dt>
							<dd ><a href="<?php echo url('home/order/home'); ?>" >我的订单</a></dd>
							<dd><a href="<?php echo url('home/order/pay'); ?>">待付款</a></dd>
							<dd><a href="<?php echo url('home/order/send'); ?>"   class="list-active">待发货</a></dd>
							<dd><a href="<?php echo url('home/order/receive'); ?>">待收货</a></dd>
						...
						<dl>
							<dt><i>·</i> 设置</dt>
							<dd><a href="seckillsetting-info.html">个人信息</a></dd>
                ...
                <div class="yui3-u-5-6 order-pay">
                    <div class="body">
                        ...
                        <div class="order-detail">
							...
							<!--order1-->
							<?php foreach($order as $k => $v): foreach($v as $key => $val): ?>
							<div class="choose-title">
								<label data-toggle="checkbox" class="checkbox-pretty ">
									<input type="checkbox" checked="checked"><span><?php echo $val['create_time']; ?>　订单编号：<?php echo $k; ?></span>
								</label>
							...
							<table class="sui-table table-bordered order-datatable">
								<tbody>
									<tr>
										...
										<td width="35%">
											<div class="typographic"><img src="/static/home/img/goods.png" />
												<a href="#" class="block-text"><?php echo $val['goods_name']; ?></a>
												<?php foreach($val['attr_values'] as $value): ?>
												<span class="guige">规格:<?php echo $value['attr_value']; ?></span>
												<?php endforeach; ?>
											</div>
										</td>
										<td width="5%" class="center">
											<ul class="unstyled">
												<li class="o-price">¥<?php echo $val['goods_price']; ?></li>
												<li><?php echo $val['goods_price']; ?></li>
											</ul>
										</td>
										<td width="5%" class="center"><?php echo $val['number']; ?></td>
										...
										<td width="10%" class="center" rowspan="2">
											<ul class="unstyled">
												<li>¥<?php echo $val['total_price']; ?></li>
												<li>（含运费：￥0.00）</li>
											</ul>
										</td>
									...
									<?php endforeach; foreach($v as $key => $val): ?>
									<tr>
										<td width="35%">
											<div class="typographic"><img src="/static/home/img/goods.png" />
												<a href="#" class="block-text"><?php echo $val['goods_name']; ?></a>
