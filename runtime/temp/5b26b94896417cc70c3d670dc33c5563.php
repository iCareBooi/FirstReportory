<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\WAMP64\www\tpshop\public/../application/home\view\order\send1.html";i:1532006060;s:54:"E:\WAMP64\www\tpshop\application\home\view\layout.html";i:1531221661;}*/ ?>
<!DOCTYPE html>
<html>
...
<div id="nav-bottom">
                            ...
                            <div class="orders">
                                ...
                                <div class="choose-title">
                                    <label data-toggle="checkbox" class="checkbox-pretty ">
                                           <input type="checkbox" checked="checked"><span>　订单编号：</span>
                                     </label>
                                    <a class="sui-btn btn-info share-btn">分享</a>
                                </div>
                                <table id="table" class="sui-table table-bordered order-datatable">
                                    <tbody>
                                        <tr>
                                            <td width="35%">
                                            ...
                                            <td width="8%" class="center">
                                                <ul class="unstyled">
                                                    ...
                                                    <li id="station" paystatus="3">已发货</li>
    ...
    <script>
        ...
        $(function(){
            ...
            var score = $("#station").attr("paystatus");
            console.log(score);
        });
    </script>
