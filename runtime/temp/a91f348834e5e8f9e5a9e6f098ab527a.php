<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"E:\WAMP64\www\tpshop\public/../application/home\view\order\pay.html";i:1531991571;s:54:"E:\WAMP64\www\tpshop\application\home\view\layout.html";i:1531221661;}*/ ?>
<!DOCTYPE html>
<html>
                ...
                <div class="yui3-u-1-6 list">
                    ...
                    <div class="person-info">
                        ...
                        <div class="person-account">
                            <span class="name"><?php echo \think\Session::get('user.username'); ?></span>
                    ...
                    <div class="list-items">
                        <dl>
							...
							<dd><a href="<?php echo url('home/order/pay'); ?>"  class="list-active">待付款</a></dd>
							<dd><a href="<?php echo url('home/order/send'); ?>"  >待发货</a></dd>
                    ...
                    <div class="body">
                        ...
                        <div class="order-detail">
                            ...
                            <div class="orders">
								...
								<?php foreach($order_goods_info as $v): ?>
                                <div class="choose-title">
										
                                    <label data-toggle="checkbox" class="checkbox-pretty ">
                                           <input type="checkbox" checked="checked"><span><?php echo $v['create_time']; ?>　订单编号：<?php echo $v['order_sn']; ?></span>
                                     </label>
                                        ...
                                        <tr>
                                            <td width="35%">
                                                <div class="typographic"><img src=<?php echo $v['goods_logo']; ?>/>
													...
													<?php foreach($v['goods_attr_id'] as $attr_name): ?>
													<span class="guige"><?php echo $attr_name['attr_value']; ?></span>
													<?php endforeach; ?>
                                                </div>
                                            </td>
